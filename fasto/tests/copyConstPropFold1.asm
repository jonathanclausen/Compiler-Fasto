...
_loop_end_8_:
	ori	$4, $0, 4
# was:	ori	_letBind_11_, $0, 4
# 	ori	_arr_ind_13_,_letBind_11_,0
	addi	$3, $2, 4
# was:	addi	_arr_reg_14_, _letBind_2_, 4
	lw	$2, 0($2)
# was:	lw	_size_reg_15_, 0(_letBind_2_)
	bgez	$4, _safe_lab_18_
...
# was:	add	_arr_reg_14_, _arr_reg_14_, _arr_ind_13_
	lw	$2, 0($3)
# was:	lw	_letBind_12_, 0(_arr_reg_14_)
# 	ori	_tmp_19_,_letBind_12_,0
	ori	$16, $2, 0
# was:	ori	_mainres_1_, _tmp_19_, 0
	ori	$2, $16, 0
