...
_loop_end_8_:
	ori	$4, $0, 4
# was:	ori	_arr_ind_11_, $0, 4
	addi	$3, $2, 4
# was:	addi	_arr_reg_12_, _letBind_2_, 4
	lw	$2, 0($2)
# was:	lw	_size_reg_13_, 0(_letBind_2_)
	bgez	$4, _safe_lab_16_
# was:	bgez	_arr_ind_11_, _safe_lab_16_
_error_lab_15_:
	ori	$5, $0, 5
# was:	ori	$5, $0, 5
...
_safe_lab_16_:
	sub	$2, $4, $2
# was:	sub	_tmp_reg_14_, _arr_ind_11_, _size_reg_13_
	bgez	$2, _error_lab_15_
# was:	bgez	_tmp_reg_14_, _error_lab_15_
	sll	$4, $4, 2
# was:	sll	_arr_ind_11_, _arr_ind_11_, 2
	add	$3, $3, $4
# was:	add	_arr_reg_12_, _arr_reg_12_, _arr_ind_11_
	lw	$2, 0($3)
# was:	lw	_mainres_1_, 0(_arr_reg_12_)
# 	ori	$2,_mainres_1_,0
	addi	$29, $29, 8
	lw	$31, -4($29)
	jr	$31
